//------------------------------------------------------------------------------
//Description: Sys_MenuButton服务接口实现BLL
//Author: WANGYX
...
{
    public class Sys_MenuButtonService : MarshalByRefObject, ISys_MenuButtonService
    {
        #region 服务实现实例
        /// <summary>
        /// 实例
        /// </summary>
        private static Sys_MenuButtonService instance;
        
        /// <summary>
        /// 实例
        /// </summary>
        public static Sys_MenuButtonService Instance
        {
            get { return instance; }
        }
        ...
        /// 静态构造方法生成单实例
        /// </summary>
        static Sys_MenuButtonService()
        {
            instance = new Sys_MenuButtonService();
        }
        
        /// <summary>
        /// 私有构造方法
        /// </summary>
        private Sys_MenuButtonService() { }
        #endregion
        ...
        {
            return DalSys_MenuButton.Singleton.GetMaxID();
        }
        ...
        {
            return DalSys_MenuButton.Singleton.Exists(ID);
        }
        ...
        {
            return DalSys_MenuButton.Singleton.ExistsDynamic(selectWhere);
        }
        ...
        {
            return DalSys_MenuButton.Singleton.GetCount(selectWhere);
        }
        ...
        {
            return DalSys_MenuButton.Singleton.GetModel(ID, fields);
        }
        ...
        {
            return DalSys_MenuButton.Singleton.GetModelDynamic(selectWhere, fields);
        }
        ...
        {
            return DalSys_MenuButton.Singleton.GetModelList(fields, topWhere, selectWhere, sort);
        }
        ...
        {
            return DalSys_MenuButton.Singleton.GetPageList(pageIndex, pageSize, selectWhere, fields, sort);
        }
        #endregion
