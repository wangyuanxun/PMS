...
namespace LogicSrvLib
{
    public class Sys_ButtonService : MarshalByRefObject, ISys_ButtonService
    {
        ...
        {
            return DalSys_Button.Singleton.UpdateDynamic(fields, selectWhere);
        }
        ...
        {
            return DalSys_Button.Singleton.Delete(ID);
        }
        ...
        {
            return DalSys_Button.Singleton.DeleteDynamic(selectWhere);
        }
        #endregion
