...
namespace LogicSrvLib
{
    public class Sys_MenuButtonService : MarshalByRefObject, ISys_MenuButtonService
    {
        ...
        {
            return DalSys_MenuButton.Singleton.UpdateDynamic(fields, selectWhere);
        }
        ...
        {
            return DalSys_MenuButton.Singleton.Delete(ID);
        }
        ...
        {
            return DalSys_MenuButton.Singleton.DeleteDynamic(selectWhere);
        }
        #endregion
