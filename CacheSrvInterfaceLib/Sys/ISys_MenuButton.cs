...
namespace CacheSrvInterfaceLib
{
    public interface ISys_MenuButtonService
    {
        ...
        /// <returns></returns>
        Sys_MenuButton GetModel(long ID, string fields = "");
        ...
        /// <param name="fields">查询返回字段 如果查询全部则不需要传入参数</param>
        /// <returns></returns>
        Sys_MenuButton GetModelDynamic(string selectWhere, string fields = "");
        ...
        /// <returns></returns>
        List<Sys_MenuButton> GetModelList(string Fields, string TopWhere = "", string SelectWhere = "", string Sort = "");
        ...
        /// <returns></returns>
        Page<Sys_MenuButton> GetPageList(int pageIndex, int pageSize, string selectWhere = "",string fields = "", string sort = "");
        #endregion
