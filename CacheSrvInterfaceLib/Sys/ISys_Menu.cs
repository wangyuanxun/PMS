...
namespace CacheSrvInterfaceLib
{
    public interface ISys_MenuService
    {
        ...
        /// <returns></returns>
        Sys_Menu GetModel(long ID, string fields = "");
        ...
        /// <param name="fields">查询返回字段 如果查询全部则不需要传入参数</param>
        /// <returns></returns>
        Sys_Menu GetModelDynamic(string selectWhere, string fields = "");
        ...
        /// <returns></returns>
        List<Sys_Menu> GetModelList(string Fields, string TopWhere = "", string SelectWhere = "", string Sort = "");
        ...
        /// <returns></returns>
        Page<Sys_Menu> GetPageList(int pageIndex, int pageSize, string selectWhere = "",string fields = "", string sort = "");
        #endregion
