...
{
    public interface ISys_ButtonService
    {
        #region 系统自动生成服务接口
        /// <summary>
        /// 获取表主键最大ID
        ...
        /// <returns></returns>
        Sys_Button GetModel(long ID, string fields = "");
        ...
        /// <param name="fields">查询返回字段 如果查询全部则不需要传入参数</param>
        /// <returns></returns>
        Sys_Button GetModelDynamic(string selectWhere, string fields = "");
        ...
        /// <returns></returns>
        List<Sys_Button> GetModelList(string Fields, string TopWhere = "", string SelectWhere = "", string Sort = "");
        ...
        /// <returns></returns>
        Page<Sys_Button> GetPageList(int pageIndex, int pageSize, string selectWhere = "",string fields = "", string sort = "");
        #endregion
